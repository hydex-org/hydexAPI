 ...
 */
import { getMXEPublicKey, getMXEAccAddress, getCompDefAccAddress, getCompDefAccOffset, getArciumProgAddress, getMempoolAccAddress, getExecutingPoolAccAddress, getComputationAccAddress, getArciumEnv, RescueCipher, x25519, compressUint128, } from "@arcium-hq/client";
...
export class ArciumPrivacyService {
    ...
    provider;
    mxePublicKey = null;
    constructor(connection, programId, provider) {
     ...
     */
    async getMXEPublicKeyWithRetry(maxRetries = 10, retryDelay = 1000) {
     ...
     */
    encryptAttestation(attestation) {
     ...
     */
    encryptZcashAddress(zcashAddress) {
        if (!this.mxePublicKey) {
            throw new Error("Arcium service not initialized");
        }
     ...
     */
    getArciumAccounts(computationOffset, instructionName) {
        ...
        return {
            ...
            compDefAccount: getCompDefAccAddress(this.programId, Buffer.from(offset).readUInt32LE()),
