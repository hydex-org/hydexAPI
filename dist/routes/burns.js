 ...
 */
burnRouter.post("/", requireAuth, async (req, res) => {
    const body = req.body;
 ...
 */
burnRouter.get("/:id", requireAuth, async (req, res) => {
 ...
 */
burnRouter.get("/", requireAuth, async (req, res) => {
 ...
 */
export function updateBurn(burnId, updates) {
    const burn = burns.get(burnId);
    if (!burn)
        return false;
...
export function getBurn(burnId) {
    return burns.get(burnId);
}
export function getAllBurns() {
