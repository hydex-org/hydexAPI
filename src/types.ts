...
export interface CreateBurnRequest {
    ...
    user: string;
    amount: string;
    zcash_address: string; // Encrypted before storage
    network: "mainnet" | "testnet";
}

// ============================================================================
// ATTESTATION TYPES (per Hydex Spec Section 6.3)
// ============================================================================

export interface AttestationInput {
    note_commitment: Uint8Array; // [u8; 32]
    amount: bigint;
    recipient_solana: Uint8Array; // [u8; 32]
    block_height: bigint;
    enclave_signature: Uint8Array; // [u8; 64]
    enclave_pubkey: Uint8Array; // [u8; 32]
}
...
export interface EnclaveAttestation {
    ...
    amount: string;
    recipient_solana: string; // base58
    block_height: number;
    enclave_signature: string; // hex
    enclave_pubkey: string; // hex
    raw_attestation_payload?: string; // base64
}
